                    ...
                    V: MapAccess<'de>,
            {
                match visitor.next_key_seed(KeyClassifier)? {
                    ...
                    Some(KeyClass::Map(first_key)) => {
                        ...
                        values.insert(Value::from(first_key), try!(visitor.next_value()));
...
fn visit_set<'de, V>(array: Set<Value>, visitor: V) -> Result<V::Value, Error>
    where
        V: Visitor<'de>,
{
    let len = array.len();
...
impl<'de> serde::Deserializer<'de> for Value {
            ...
            V: Visitor<'de>,
    {
        match self {
            ...
            Value::Vector(v) => visit_array(v, visitor),
            Value::Map(v) => visit_object(v, visitor),
            Value::Set(v) => visit_array(v, visitor),
            Value::Tagged(v,v2) => unimplemented!(),
        }
    }
...
impl<'de> serde::Deserializer<'de> for &'de Value {
            ...
            V: Visitor<'de>,
    {
        match *self {
            ...
            Value::Vector(ref v) => visit_array_ref(v, visitor),
            Value::Set(ref v) => visit_array_ref(v, visitor),
...
//            #[inline]
//            fn visit_f64<E>(self, value: f64) -> Result<Value, E> {
//                Ok(Number::from_f64(value).map_or(Value::Nil, Value::Float4))
//            }
//
//            #[inline]
//            fn visit_str<E>(self, value: &str) -> Result<Value, E>
