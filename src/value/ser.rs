...
impl Serialize for Value {
            ...
            S: ::serde::Serializer,
    {
        match *self {
            ...
            Value::Symbol(ref v) => v.serialize(serializer),
...
impl serde::Serializer for Serializer {
            ...
            T: Serialize,
    {
        ...
        values.insert(Value::String(String::from(variant)), try!(to_value(&value)));
        Ok(Value::Map(values))
    }
...
impl serde::ser::SerializeTupleVariant for SerializeTupleVariant {
    ...
    fn end(self) -> Result<Value, Error> {
        ...
        object.insert(Value::from(self.name), Value::Vector(self.vec));
